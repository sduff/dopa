...
resource "confluent_kafka_topic_v3" "orders1" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  topic_name    = "team-a:orders1"
...
resource "confluent_kafka_topic_v3" "orders2" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  topic_name    = "team-a:orders2"
  rest_endpoint = confluent_kafka_cluster_v2.basic.rest_endpoint
  credentials {
    key    = confluent_api_key_v2.app-manager-kafka-api-key.id
    secret = confluent_api_key_v2.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic_v3" "orders3" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  topic_name    =
...
resource "confluent_kafka_topic_v3" "orders4" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  topic_name    = "team-a:orders4"
  rest_endpoint = confluent_kafka_cluster_v2.basic.rest_endpoint
  credentials {
    key    = confluent_api_key_v2.app-manager-kafka-api-key.id
    secret = confluent_api_key_v2.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic_v3" "orders5" {
  kafka_cluster {
    id = confluent_kafka_cluster_v2.basic.id
  }
  topic_name    = "team-abc:orders"
  rest_endpoint = confluent_kafka_cluster_v2.basic.rest_endpoint
  credentials {
    key    = confluent_api_key_v2.app-manager-kafka-api-key.id
    secret = confluent_api_key_v2.app-manager-kafka-api-key.secret
